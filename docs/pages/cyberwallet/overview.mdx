...
The new [CyberWallet](https://passkey.cyber.co) is an AA wallet that exclusively supports the Cyber mainnet and leverages passkey technology for secure login.
