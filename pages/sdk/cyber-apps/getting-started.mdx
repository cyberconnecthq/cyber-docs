...
1. (Experimental) using `CyberProvider` and `CyberApp` to create a EIP-1193 provider with existing Ethereum libraries like wagmi.
2. using `CyberApp` directly

### 1. Using with wagmi (experimental)

<Callout type="warning" emoji="⚠️">
  Please update the package to the beta version to use this feature.
</Callout>
